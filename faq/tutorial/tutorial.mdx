...
## Tutorial for How to Transfer funds between System and Staking 

<ReactPlayer width="100%" controls url="https://youtu.be/SXjC5LMlV_s" />

## Tutorial for How to Access Your Secret Phrase

<ReactPlayer width="100%" controls url="https://www.youtube.com/watch?v=HtmQH0d7Gwo" />

## Tutorial for get a stoarge key in spheron.network 
**By Emil Justine**

- Go to [Spheron](https://app.spheron.network/)
- Register/Sign-up using Web2 (recommend Github account)
- On the upper right corner you will see your profile, click on it
- Click Settings
- Click Tokens
- Click Create Token
...
---
:::info example
- Token Name: SpheronKey1
- Type: Storage
- Scope: (Which is your organization's name on registration)
- Expiration: 1 Year or No Expiration
- Click Create
:::
---
- Copy the key and save it in a notepad for backups then go to Koii Node and create a label
- Key Input: (Your Spheron Key)
- Add and done, then add it on your tasks
