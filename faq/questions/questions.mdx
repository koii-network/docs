...
The tasks status is listed in My Node page. If the task is shown as "Error" and Stops running, please check the task log to see what's wrong. If you have trouble fixing the error, please contact us on [Discord](https://discord.com/invite/koii-network).
