...
After logging in to Koii Node, you will see the available task list. Stake some KOII tokens to the task you want to run. After staking, please click "Run" button to run the task. Some tasks need to set up the task environment to run. Please follow the instructions to complete the item set up.
