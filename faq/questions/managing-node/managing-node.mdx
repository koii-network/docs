...
We strongly recommend using the default extension names "Spheron_Storage", "TWITTER_USERNAME", and "KEYWORD" etc, noting that these are **case-sensitive**, for tasks. This practice ensures that task configurations are automatically paired when you start the task.
