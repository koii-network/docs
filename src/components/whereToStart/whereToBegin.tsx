...
export const WhereToBegin = () => {
  ...
  return (
   <div className="w-full px-4 lg:px-8 max-w-[1350px] mx-auto flex flex-col items-center text-koii-purple-2 font-semibold">
    ...
    <div className="w-full flex flex-col gap-10 lg:grid lg:grid-cols-5 lg:gap-6">
       {
        sections.map((section)=>{
            return(
                <a href={section.link} className="w-full flex flex-col gap-6 max-w-[320px] mx-auto lg:max-w-auto">
                    <Button>
                        {section.name}
                    </Button>
                    <img
