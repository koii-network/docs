  ...
  themeConfig:
    ...
    ({
      ...
      metadata: [
        ...
        {property: 'og:image', content: 'https://www.koii.network/static/thumbnail.png'},
        {property: 'og:description', content: 'Koii is Web3, for everyone.'},
        {property: 'twitter:card', content: 'summary_large_image'},
        {property: 'twitter:description', content: 'Koii is Web3, for everyone.'},
        {property: 'twitter:image', content: 'https://www.koii.network/static/thumbnail.png'},
      ],
      navbar: {
        title: 'Koii Docs',
        logo: {
