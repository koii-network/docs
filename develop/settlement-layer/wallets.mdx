...
<ContentLink title="Finnie for Devs" link="/" iconType="copy"/>
...
**Note:** Your collateral will never be confiscated for honest work [(see the Audits section for more information)](../microservices-and-tasks/what-are-tasks/what-are-audits.md)
...
<ContentLink title="Using the Koii CLI" link="/" iconType="copy"/>
