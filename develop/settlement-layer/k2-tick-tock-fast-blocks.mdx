...
**Heads up!:** To use K2, you'll need to install the [Koii CLI](https://docs.koii.network/microservices-and-tasks/task-development-guide/task-development-flow/koii-cli) or try the [Koii SDK](../koii-software-toolkit-sdk/what-is-the-koii-sdk.md), which provides vital functions such as creating wallets, sending transactions, and signing data.
