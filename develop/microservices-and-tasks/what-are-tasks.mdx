...
1.  Tasks Overview
    ...
    a. [Why use decentralized nodes when servers seem to work?](nodes-vs-servers.md)<br/>
    b. [How do tasks run across many nodes?](gradual-consensus.md)<br/>
    c. [What does it take to build a task?](key-components.md)<br/>
    d. [Where does task data live?](runtime-environment.md)<br/>
    e. [Managing collateral and voting](staking-and-voting.md)<br/>
    f. [Securing tasks with audits](what-are-audits.md)
...
4. [Task Design Example ](../quote-of-the-day-example-task/)
5. [Run a Task Node](../run-a-task-node.md)
6. [Using Reputation to reduce waste compute (a.k.a. CARP)](../using-reputation.md)
