...
Whenever we refer to task account, we mean the task <mark style={{color:"orange"}}>State Info Pubkey</mark>.

The bounty amount will be present in <mark style={{color:"orange"}}>Stake Pot Account</mark>
