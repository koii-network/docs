...
The task lifecycle consists of three phases: submission, audit, and distribution. A task is divided into rounds, with the three phase stacking on top of each other.

![stacking rounds](/img/concepts/gradual-consensus/stacking-rounds.svg)
