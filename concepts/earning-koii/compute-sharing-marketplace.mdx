...
Once a content creator or app developer [mines KOII,](attention-mining.mdx) they have the option of staking their new tokens as collateral against either a Task Node or a K2 Settlement Node. Task Nodes provide web app and microservice hosting and support an open and extensible consensus process known as [Gradual Consensus](/), while [Settlement Nodes](/) provide fast payments using a storage-based Solana fork.&#x20;
