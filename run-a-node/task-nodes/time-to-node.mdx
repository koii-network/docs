...
:::info
To get a Spheron Key, set it up in your Koii Node App, see [tutorial](https://docs.koii.network/koii/faq#tutorial-step-by-step-guide-to-getting-a-spheron-storage-key). If you already have the key setup in the Koii App you can find it in settings. 
:::
