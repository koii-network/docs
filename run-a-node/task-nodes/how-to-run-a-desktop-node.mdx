...
import DesktopNodeButton from "@site/src/components/buttons/desktop-node-button";
...
<h2 id='what-exactly-is-a-koii-node' style={{fontSize: '32px'}}>What exactly is a Koii node?</h2>
...
<h2 id='how-do-i-run-a-node' style={{fontSize: '32px'}}>How do I run a node?</h2>
...
If you have Windows, [get this download](https://github.com/koii-network/desktop-node/releases/download/v0.2.14/koii-desktop-node-0.2.14-win-x64.exe).
...
If you have an M1 or M2 chip, [get this download](https://github.com/koii-network/desktop-node/releases/download/v0.2.14/koii-desktop-node-0.2.14-mac-arm64.dmg). If you have an Intel chip, [get this download](https://github.com/koii-network/desktop-node/releases/download/v0.2.14/koii-desktop-node-0.2.14-mac-x64.dmg).
...
:::note
If you want your node to update automatically, you must use [AppImage](https://github.com/koii-network/desktop-node/releases/download/v0.2.14/koii-desktop-node-0.2.14-linux-x86_64.AppImage).
:::
...
<h2 id='get-those-tokens' style={{fontSize: '32px'}}>Get those tokens!</h2>
...
<h2 id='become-a-pirate' style={{fontSize: '32px'}}>Run your first task, become a pirate</h2>
