---
title: How to Run a Desktop Node
...
<h2 id="what-exactly-is-a-koii-node" style={{ fontSize: "32px" }}>
  What is the Desktop Node?
</h2>

A Desktop Node is a very small computer program—about the same size as your favorite music player—that allows you to run compute jobs called **[tasks](/develop/koii-task-101/what-are-tasks)** for people around the world. They pay you to rent the extra space, like Uber for your computer, but it stays on your desk at all times.
...
<h2 id="time-to-node" style={{ fontSize: "32px" }}>
  Time to Node
</h2>
...
<h2 id="get-those-tokens" style={{ fontSize: "32px" }}>
  Get those tokens!
</h2>
...
<h2 id="become-a-pirate" style={{ fontSize: "32px" }}>
